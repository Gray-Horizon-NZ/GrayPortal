...
export default async function PortalAccountPage() {
  ...
  const [tools, referrals, referralStats, meetings] = await Promise.all([
  ...
  const nothingEnabled = !has("tool_stack") && !has("referrals") && !has("meeting_summaries");

  return (
    <div>
      <div className="ghp-page-head">
        <h1>Account</h1>
        <div className="ghp-sub">Tool stack, referrals and meeting summaries</div>
      </div>
